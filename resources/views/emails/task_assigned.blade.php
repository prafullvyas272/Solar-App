                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            <td style="padding:15px 0px 0px 15px;" align="left">
                                                <p
                                                    style="font-size:14pt;font-family:'Calibri',sans-serif;color:#333333;">
                                                    Hello {{ $assignedUser }},
                                                </p>
                                                <p style="font-size:12pt;color:#333333;">
                                                    You have been assigned a new task. Below are the task details:
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding: 20px 0;">
                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr style="border-bottom: 1px solid #eeeeee;">
                                                        ...
                                                        <td style="padding:10px 0; color:#891AB4 ;">{{ $task->title }}
                                                        </td>
                                                    </tr>
                                                    <tr style="border-bottom: 1px solid #eeeeee;">
                                                        <td style="padding:10px 0;"><b>Project Name</b></td>
                                                        <td style="padding:10px 0; color:#891AB4 ;">{{ $projectName }}
                                                        </td>
                                                    </tr>
                                                    <tr style="border-bottom: 1px solid #eeeeee;">
                                                        <td style="padding:10px 0;"><b>Assigned By</b></td>
                                                        <td style="padding:10px 0; color:#891AB4 ;">{{ $createdBy }}
                                                        </td>
                                                    </tr>
                                                    <tr style="border-bottom: 1px solid #eeeeee;">
                                                        <td style="padding:10px 0;"><b>Due Date</b></td>

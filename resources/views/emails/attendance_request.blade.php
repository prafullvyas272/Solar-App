                            ...
                            <div style="background-color:#ffffff;border:1px solid #dedede;margin:0;padding:15px;">
                                <table width="100%" align="center" role="presentation" border="0" cellpadding="0"
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            <td colspan="2"
                                                style="padding: 10px 15px 10px 5px; margin-bottom: 20px; background-color: #891AB4 !important; color: #fff !important; border-radius: 0; border-bottom: 0; font-size: 20px; font-weight: bold;">
                                        ...
                                        <tr>
                                            <td style="padding: 20px 0;">
                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding:10px 0;"><b>Note</b></td>
                                                        <td style="padding:10px 0; color:#891AB4 ;">
                                                            {{ $note }}</td>
                                                    </tr>
                                                </table>

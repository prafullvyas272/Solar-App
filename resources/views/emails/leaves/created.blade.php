                                    ...
                                    <thead>
                                            ...
                                            <td style="padding: 20px 0;">
                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr style="border-bottom: 1px solid #eeeeee;">
                                                        <td style="padding:10px 0;"><b>Employee ID</b></td>
                                                        <td style="padding:10px 0; color:#891AB4 ;">{{ $employeeId }}
                                                        </td>
                                                    </tr>
                                                    <tr style="border-bottom: 1px solid #eeeeee;">
                                                        <td style="padding:10px 0;"><b>Employee Name</b></td>
                                        ...
                                        <tr>
                                            <td style="text-align:center;">
                                                <a href="{{ url('admin/leaves') }}" target="_blank"

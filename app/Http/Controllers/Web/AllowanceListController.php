...
class AllowanceListController extends Controller
{
    ...
    {
        $request->merge(['AccessCode' => config('menuAccessCode.ALLOWANCE')]);
        ...
        return view('allowance.allowance_index', ['permissions' => $permissions, 'menuName' => $menuName]);
    }
    public function create(Request $request)
    {
        $allowanceId = $request->input('id');

        return view('allowance.allowance_create', compact('allowanceId'));
    }
}

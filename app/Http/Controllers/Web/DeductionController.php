...
class DeductionController extends Controller
{
    ...
    {
        $request->merge(['AccessCode' => config('menuAccessCode.DEDUCTION')]);
        ...
        return view('deduction.deduction_index', ['permissions' => $permissions, 'menuName' => $menuName]);
    }
    public function create(Request $request)
    {
        $deductionId = $request->input('id');

        return view('deduction.deduction_create', compact('deductionId'));
    }
}
